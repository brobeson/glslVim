...
let s:glsl_builtins = [
	...
	\					'abbr': '__FILE__',
	\					'info': "\/\/ Integer representing the current source string" },
	\ { 'kind': 'd',	'word': '__LINE__',
	\					'abbr': '__LINE__',
	\					'info': "\/\/ The line number where the macro is used" },
	\ { 'kind': 'd',	'word': '__VERSION__',
	\					'abbr': '__VERSION__',
	\					'info': "\/\/ Integer representing the GLSL version used" },
	\ { 'kind': 'v',	'word': 'gl_ClipDistance',
	\					'abbr': 'gl_ClipDistance',
	\					'info': "\/\/ tessallation control, tessallation evaulation, geometry:\n" .
	...
	\					'abbr': 'gl_FragDepth',
	\					'info': "\/\/ fragment: The depth of the fragment\n" .
	\							"out float gl_FragDepth;" },
	\ { 'kind': 'v',	'word': 'gl_FrontFacing',
	\					'abbr': 'gl_FrontFacing',
	\					'info': "\/\/ fragment: true if the fragment is front facing, false if it is\n" .
	\							"\/\/           back facing\n" .
	\							"in bool gl_FrontFacing;" },
	\ { 'kind': 'v',	'word': 'gl_GlobalInvocationID',
	\					'abbr': 'gl_GlobalInvocationID',
	\					'info': "\/\/ compute input: the unique ID for an invocation of a compute\n" .
	\							"\/\/                shader, with a work group\n" .
	\							"in uvec3 gl_GlobalInvocationID;" },
	\ { 'kind': 'v',	'word': 'gl_HelperInvocation',
	\					'abbr': 'gl_HelperInvocation',
	\					'info': "\/\/ fragment: no documentation available\n" .
	\							"in bool gl_HelperInvocation;" },
	\ { 'kind': 'v',	'word': 'gl_in',
	\					'abbr': 'gl_in',
	\					'info': "\/\/ tessallation control, tessallation evaluation, geometry:\n" .
	\							"\/\/     the instance of gl_PerVertex\n" .
	\							"in gl_PerVertex { /*...*/ } gl_in[];" },
	\ { 'kind': 'v',	'word': 'gl_InstanceID',
	\					'abbr': 'gl_InstanceID',
	\					'info': "\/\/ vertex: the index of the current instance when using instanced\n" .
	\							"\/\/         rendering, 0 otherwise\n" .
	\							"in int gl_InstanceID;" },
	\ { 'kind': 'v',	'word': 'gl_InvocationID',
	\					'abbr': 'gl_InvocationID',
	\					'info': "\/\/ tessallation control: the index of the TCS invocation in this patch\n" .
	\							"\/\/ geometry input: the current instance\n" .
	\							"in int gl_InvocationID;\n" },
	\ { 'kind': 'v',	'word': 'gl_Layer',
	\					'abbr': 'gl_Layer',
	\					'info': "\/\/ geometry: the layer to which a primitive goes\n" . 
	\							"out int gl_Layer;\n\n" .
	\							"\/\/ fragment: the layer for the fragment, output by the geometry shader\n" .
	\							"in int gl_Layer;" },
	\ { 'kind': 'v',	'word': 'gl_LocalGroupSize',
	\					'abbr': 'gl_LocalGroupSize',
	\					'info': "\/\/ compute: no documentation available\n" .
	\							"in uvec3 gl_LocalGroupSize;" },
	\ { 'kind': 'v',	'word': 'gl_LocalInvocationID',
	\					'abbr': 'gl_LocalInvocationID',
	\					'info': "\/\/ compute: the current invocation of the shader within the work group\n" .
	\							"in uvec3 gl_LocalInvocationID;" },
	\ { 'kind': 'v',	'word': 'gl_LocalInvocationIndex',
	\					'abbr': 'gl_LocalInvocationIndex',
	\					'info': "\/\/ compute: the (1-D) index of the shader invocation within the work group\n" .
	\							"in uint gl_LocalInvocationIndex;" },
	\ { 'kind': 'v',	'word': 'gl_NumWorkGroups',
	\					'abbr': 'gl_NumWorkGroups',
	\					'info': "\/\/ compute: the number of work groups used when dispatching the compute shader\n" .
	\							"in uvec3 gl_NumWorkGroups;" },
	\ { 'kind': 'v',	'word': 'gl_out',
	\					'abbr': 'gl_out',
	\					'info': "\/\/ tessalation control: the instance of gl_PerVertex for output\n" .
	\							"out gl_PerVertex { /*...*/ } gl_out[];" },
	\ { 'kind': 'v',	'word': 'gl_PatchVerticesIn',
	\					'abbr': 'gl_PatchVerticesIn',
	\					'info': "\/\/ tessallation control & evaluation: the number of vertices in the\n" .
	\							"\/\/                                    input patch\n" .
	...
	\					'abbr': 'gl_PointCoord',
	\					'info': "\/\/ fragment: the location of a fragment within a point primitive\n" .
	...
	\					'abbr': 'gl_PrimitiveID',
	\					'info': "\/\/ tessallation control: the index of the current patch\n" .
	...
	\					'info': "\/\/ geometry: the ID of the current input primitive\n" .
	\							"in int gl_PrimitiveIDIn;" },
	\ { 'kind': 'v',	'word': 'gl_SampleID',
	\					'abbr': 'gl_SampleID',
	\					'info': "\/\/ fragment: the ID of the current sample within a fragment\n" .
	\							"in int gl_SampleID;" },
	\ { 'kind': 'v',	'word': 'gl_SampleMask',
	\					'abbr': 'gl_SampleMask',
	\					'info': "\/\/ fragment: the sample mask for the fragment, when using\n" .
	\							"\/\/           multisampled rendering\n" .
	\							"out int gl_SampleMask[];" },
	\ { 'kind': 'v',	'word': 'gl_SampleMaskIn',
	\					'abbr': 'gl_SampleMaskIn',
	\					'info': "\/\/ fragment: bitfield for the sample mask of the current fragment\n" .
	\							"in int gl_SampleMaskIn[];" },
	\ { 'kind': 'v',	'word': 'gl_SamplePosition',
	\					'abbr': 'gl_SamplePosition',
	\					'info': "\/\/ fragment: the location of the current sample within the current fragment\n" .
	\							"in vec2 gl_SamplePosition;" },
	\ { 'kind': 'v',	'word': 'gl_TessCoord',
	\					'abbr': 'gl_TessCoord',
	\					'info': "\/\/ tessallation evaluation: the location of a vertex within the\n" .
	\							"\/\/                          tessallated abstract patch\n" .
	\							"in vec3 gl_TessCoord;" },
	\ { 'kind': 'v',	'word': 'gl_TessLevelInner',
	\					'abbr': 'gl_TessLevelInner',
	\					'info': "\/\/ tessallation control: the inner tessallation level\n" .
	...
	\					'info': "\/\/ tessallation control: the outer tessallation level\n" .
	...
	\					'abbr': 'gl_VertexID',
	\					'info': "\/\/ vertex: the index of the vertex currently being processed\n" .
	\							"in int gl_VertexID;" },
	\ { 'kind': 'v',	'word': 'gl_ViewportIndex',
	\					'abbr': 'gl_ViewportIndex',
	\					'info': "\/\/ geometry: specifies which viewport to use for the primitive\n" .
	...
	\					'abbr': 'gl_WorkGroupID',
	\					'info': "\/\/ compute: the current work group for the shader invocation\n" .
	\							"in uvec3 gl_WorkGroupID;" },
	\ { 'kind': 'v',	'word': 'gl_WorkGroupSize',
	\					'abbr': 'gl_WorkGroupSize',
	\					'info': "\/\/ compute: the size of the local work group\n" .
